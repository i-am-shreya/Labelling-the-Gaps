...
#    attention_mul = Dense(64)(attention_mul)
    ...
    output_label = Dense(1, activation='sigmoid',name = 'Output_label',kernel_regularizer=regularizers.l2(0.01),
...
model.save('./models/video_eyegaze_onelabel_kl_sgd0.01_normalizedlabel_mpii_1000.h5')
...
Y_original_unlabel=np.zeros([len(original_unlabel),1])
...
model.load_weights('./models/video_eyegaze_onelabel_kl_sgd0.01_normalizedlabel_mpii_1000.h5')
