# -*- coding: utf-8 -*-
"""
Created on Tue Jan  7 16:33:26 2020
...
history = model.fit(
    ...
    [all_end_frames_l,Y_start_gaze_label,all_end_frames_l],
    epochs=50,
    batch_size=32,callbacks=[checkpoint])

model.load_weights('./models/best_weights.h5')
model.save('./models/video_eyegaze_onelabel_sgd0.01_normalizedlabel.h5')
